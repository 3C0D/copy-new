...
class OnboardingWindow(QtWidgets.QWidget):
    ...
    def show_welcome_screen(self):
        ...
        shortcut_label = QtWidgets.QLabel(
            'Customize your shortcut key (default: "ctrl+space"):'
        )
        ...
        gradient_radio.setStyleSheet(
            f"color: {'#ffffff' if colorMode == 'dark' else '#333333'};"
        )
        plain_radio.setStyleSheet(
            f"color: {'#ffffff' if colorMode == 'dark' else '#333333'};"
        )
        ...
        next_button.clicked.connect(
            lambda: self.on_next_clicked(gradient_radio.isChecked())
        )
