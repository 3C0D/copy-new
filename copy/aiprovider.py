...
class GeminiProvider(AIProvider):
    ...
    def __init__(self, app):
        ...
        settings = [
            ...
            DropdownSetting(
                name="model_name",
                display_name="Model",
                default_value=DEFAULT_MODELS["gemini"],
    ...
    def get_response(
        ...
        try:
            ...
            error_str = str(e)
            logging.error(f"Error processing Gemini response: {error_str}")
        ...
        if hasattr(self, "api_key") and self.api_key and self.api_key.strip():
            ...
            self.model = genai.GenerativeModel(
                ...
                generation_config=genai.types.GenerationConfig(
                    candidate_count=1, max_output_tokens=1000, temperature=0.5
                ),
                safety_settings={
    ...
    def __init__(self, app):
        ...
        settings = [
            ...
            DropdownSetting(
                ...
                default_value=DEFAULT_MODELS["openai"],
    ...
    def __init__(self, app):
        ...
        settings = [
            ...
            DropdownSetting(
                name="api_model",
                display_name="API Model",
                default_value=DEFAULT_MODELS["ollama"],
...
class AnthropicProvider(AIProvider):
    ...
    def __init__(self, app):
        ...
        settings = [
            ...
            DropdownSetting(
                name="api_model",
                display_name="API Model",
                default_value=DEFAULT_MODELS["anthropic"],
    ...
    def get_response(
        ...
        try:
            ...
            error_str = str(e)
            logging.error(f"Anthropic API error: {error_str}")
...
class MistralProvider(AIProvider):
    ...
    def __init__(self, app):
        ...
        settings = [
            ...
            DropdownSetting(
                name="api_model",
                display_name="API Model",
                default_value=DEFAULT_MODELS["mistral"],
    ...
    def get_response(
        ...
        try:
            ...
            error_str = str(e)
            logging.error(f"Mistral API error: {error_str}")
            self.app.show_message_signal.emit(
                "Mistral Error",
