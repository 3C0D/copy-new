...
class HelpWindow(ThemedWidget):
    ...
    def _get_help_content(self) -> str:
        ...
        <div style='text-align: left; line-height: 1.6;'>
            <h2>🎯 {_("How to Use Writing Tools")}</h2>
            
            <h3>🖼️ {_("Image Processing Priority")}</h3>
            ...
            <h3>📝 {_("Text Selection & Interaction Modes")}</h3>
            ...
            <div style='margin-left: 20px; margin-bottom: 15px;'>
                <h4>⚡ {_("Predefined Action Buttons")}</h4>
            ...
            <h3>⚙️ {_("Settings & Configuration")}</h3>
            ...
            <div style='margin-top: 30px; padding: 15px; background: rgba(76, 175, 80, 0.1); border-radius: 8px;'>
                <strong>💡 {_("Quick Reference:")}</strong><br>
